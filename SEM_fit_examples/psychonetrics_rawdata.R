...
# This script fits the model using the RAW data, see psychonetrics_sumstat.R for an example
...
# Form model:
mod3b <- lvm(PoliticalDemocracy, lambda = Lambda, beta = Beta, sigma_epsilon = Sigma_epsilon)
